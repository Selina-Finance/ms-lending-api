...
public interface LoanInformationMapperConfig {
    ...
    void mapLoanInformationDto(LoanInformation loanInformation, @MappingTarget LoanInformationDto loanInformationDto);
    void mapLoanInformation(LoanInformationDto loanInformationDto, @MappingTarget LoanInformation loanInformation);
}
