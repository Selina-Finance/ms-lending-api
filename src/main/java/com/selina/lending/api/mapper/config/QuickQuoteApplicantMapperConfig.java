...
public interface QuickQuoteApplicantMapperConfig extends ApplicantMapperConfig {
    ...
    void mapQuickQuoteApplicantDto(Applicant applicant, @MappingTarget QuickQuoteApplicantDto quickQuoteApplicantDto);

    @InheritConfiguration(name = "mapApplicant")
    void mapQuickQuoteApplicant(QuickQuoteApplicantDto dipApplicantDto, @MappingTarget Applicant applicant);
