...
public interface DIPApplicationResponseMapper {
    DIPApplicationResponseMapper INSTANCE = Mappers.getMapper(DIPApplicationResponseMapper.class);

    @Mapping(target= "requestType", source = "applicationResponse.applicationType")
    DIPApplicationResponse mapToApplicationResponseDto(ApplicationResponse applicationResponse);
}
