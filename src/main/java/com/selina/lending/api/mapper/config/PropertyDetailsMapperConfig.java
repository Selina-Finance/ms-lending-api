...
public interface PropertyDetailsMapperConfig {
    ...
    void mapPropertyDetailsDto(PropertyDetails propertyDetails, @MappingTarget PropertyDetailsDto propertyDetailsDto);
    void mapPropertyDetails(PropertyDetailsDto propertyDetailsDto, @MappingTarget PropertyDetails propertyDetails);
}
