...
public interface ApplicationMapperConfig {
    void mapApplicationDto(Application application, @MappingTarget ApplicationDto applicationDto);
    void mapApplication(ApplicationDto applicationDto, @MappingTarget Application application);
}
