...
class QuickQuoteApplicationMapperTest extends MapperBase {
    ...
    void mapToQuickQuoteApplicationDto() {
        ...
        //When
        var applicationDto = QuickQuoteApplicationMapper.INSTANCE.mapToQuickQuoteApplicationDto(application);
    ...
    void mapToApplication() {
        //Given
        var applicationDto = getQuickQuoteApplicationDto();

        //When
        var application = QuickQuoteApplicationMapper.INSTANCE.mapToApplication(applicationDto);
        ...
        assertThat(application.getApplicationType(), equalTo(APPLICATION_TYPE));
