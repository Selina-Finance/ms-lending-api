...
class QuickQuoteEligibilityApplicationResponseMapperTest extends MapperBase {

    @Test
    void mapToQuickQuoteResponseDecisionAccepted() {
        //Given
        var eligibilityDecisionResponse = getQuickQuoteEligibilityDecisionResponse();
    ...
    void mapToQuickQuoteResponseDecisionDeclined() {
        ...
        var eligibilityDecisionResponse =
                QuickQuoteEligibilityDecisionResponse.builder().decision(decision).build();

        //When
        var response = QuickQuoteEligibilityApplicationResponseMapper.INSTANCE.mapToQuickQuoteResponse(eligibilityDecisionResponse);
