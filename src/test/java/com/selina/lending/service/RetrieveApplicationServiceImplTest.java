...
class RetrieveApplicationServiceImplTest {
    ...
    void shouldGetApplicationByExternalApplicationId() {
        ...
        when(applicationDecisionResponse.getApplicationType()).thenReturn(LendingConstants.DIP_APPLICATION_TYPE);
        when(applicationDecisionResponse.getDecision()).thenReturn(LendingConstants.ACCEPT_DECISION);
        ...
        verify(ruleOutcomeFilter, times(1)).filterOfferRuleOutcomes(LendingConstants.ACCEPT_DECISION, LendingConstants.DIP_APPLICATION_TYPE, offers);
    }
    ...
    void shouldGetApplicationByExternalApplicationIdForQuickQuote() {
        ...
        //Then
        verify(middlewareRepository, times(1)).getApplicationById(APPLICATION_ID);
        verify(ruleOutcomeFilter, times(1)).filterOfferRuleOutcomes(LendingConstants.ACCEPT_DECISION, "QuickQuote", offers);
    }
